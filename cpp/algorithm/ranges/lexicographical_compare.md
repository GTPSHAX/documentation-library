...
At most $2&middot;min(N1, N2)$ applications of the comparison and corresponding projections, where `1=N1 = ranges::distance(first1, last1)` and `1=N2 = ranges::distance(first2, last2)`.

...
- `{{spar` - multi-line-content|A character sequence which does not contain the character sequence `*/`
- `{{spar` - single-line-content|A character sequence which does not contain any new line character

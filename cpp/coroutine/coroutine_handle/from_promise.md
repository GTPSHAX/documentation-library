---
title: std::coroutine_handle::from_promise
type: Utilities
...
Creates a `coroutine_handle` from the promise object of a coroutine. The created `coroutine_handle` refers the coroutine, and  returns a reference to `p`.

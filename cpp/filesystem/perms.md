...
Access permissions model [https://pubs.opengroup.org/onlinepubs/9699919799/basedefs/sys_stat.h.html POSIX permission bits], and any individual file permissions (as reported by `std::filesystem::status|filesystem::status`) are a combination of some of the following bits:
...
| tt | unknown |
| c | 0xFFFF |
| Unknown permissions (e.g. when lc | std::filesystem::file_status | filesystem::file_status is created without permissions) |

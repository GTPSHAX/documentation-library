---
title: std::basic_stringbuf::overflow
type: Input/output
...
If `c` is the end-of-file indicator (`1=traits::eq_int_type(c, traits::eof()) == true`), then there is no character to append. The function does nothing and returns an unspecified value other than `traits::eof()`.

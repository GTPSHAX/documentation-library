...
[https://pubs.opengroup.org/onlinepubs/9699919799/functions/fgets.html POSIX additionally requires] that `fgets` sets `errno` if it encounters a failure other than the end-of-file condition.
Although the standard specification is [https://stackoverflow.com/questions/23388620 unclear] in the cases where `1=count <= 1`, common implementations do

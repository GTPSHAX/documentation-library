...
If `1=mode > 0`, attempts to make `stream` wide-oriented. If `1=mode < 0`, attempts to make `stream` byte-oriented. If `1=mode == 0`, only queries the current orientation of the stream.

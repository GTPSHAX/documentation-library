...
[https://pubs.opengroup.org/onlinepubs/9699919799/functions/rename.html POSIX] specifies many additional details on the semantics of this function, which are reproduced in C++ by `std::filesystem::rename`.

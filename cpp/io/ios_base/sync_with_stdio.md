...
| WG | Std | Before | After |
|----|------|--------|-------|
| lwg-49 | C++98 | it was unspecified (1) which state is actually returned and<br>(2) what does 'synchronized' between standard C and C++ streams mean | both specified |

...
3. Sets the `floatfield` of the stream `str` to `fixed` and `scientific` simultaneously as if by calling `str.setf(std::ios_base::fixed . This enables hexadecimal floating-point formatting.

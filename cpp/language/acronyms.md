...
title: Acronyms
type: Language
source: https://en.cppreference.com/w/cpp/language/acronyms
---
...
| lc | std::move_only_function, lc | std::function, lc | std::any. See also ls | #SBO, ls | #SSO |
| -id="SSO" |
| SSO |
| Small String Optimization |
| lc | std::basic_string. See also ls | #SBO, ls | #SOO |
| - |
| STL |

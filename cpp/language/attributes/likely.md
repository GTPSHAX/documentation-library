...
`1=i == 2` is considered more likely than any other value of `i`, but the `likely` has no effect on the `1=i == 1` case even though it falls through the `case 2:` label.

...
In a , the class name of the current class or the template name of the current class template is treated as if it were a public member name; this is called ''injected-class-name''. The point of declaration of the name is immediately following the opening brace of the class (template) definition.
...
| WG | Std | Before | After |
|----|------|--------|-------|
| cwg-1004 | C++98 | an injected-class-name could not<br>be a template template argument | allowed, it refers to the class<br>template itself in this case |

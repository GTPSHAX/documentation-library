...
| WG | Std | Before | After |
|----|------|--------|-------|
| cwg-45 | C++98 | the members of a nested class cannot<br>access the enclosing class and its friends | they have the same access rights as<br>other members of the enclosing class<br>(also resolves CWG issues #8 and #10) |

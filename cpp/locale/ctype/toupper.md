...
Only 1:1 character mapping can be performed by this function, e.g. the uppercase form of 'ß' is the two-character string "SS" (with some  exceptions - see [https://en.wikipedia.org/wiki/Capital_%E1%BA%9E «Capital ẞ»]), which cannot be obtained by `do_toupper`.

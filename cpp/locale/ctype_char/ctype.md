...
Creates a `std::ctype<char>` facet and forwards the starting reference count `refs` to the base class constructor, `cpp/locale/locale/facet/facet|locale::facet::facet()`.

...
If `1=(unsigned char)c >= std::ctype<char>::table_size`, then an implementation-defined value is substituted instead of `table()[(unsigned char)c]`, possibly different for different values of `c`.

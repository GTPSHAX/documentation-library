...
* the last remaining `shared_ptr` owning the object is assigned another pointer via `1=operator=` or `reset()`.
...
| dsc|`element_type`| | |
| <sup>(until C++17)</sup> `T` | |
| <sup>(since C++17)</sup> `std::remove_extent_t<T>` | |
...
| cpp/memory/shared_ptr/dsc swap | (see dedicated page) |

#### Observers

| cpp/memory/shared_ptr/dsc get | (see dedicated page) |
| cpp/memory/shared_ptr/dsc operator* | (see dedicated page) |
| cpp/memory/shared_ptr/dsc operator_at | (see dedicated page) |
| cpp/memory/shared_ptr/dsc use_count | (see dedicated page) |
| cpp/memory/shared_ptr/dsc unique | (see dedicated page) |
| cpp/memory/shared_ptr/dsc operator bool | (see dedicated page) |
...
| cpp/memory/shared_ptr/dsc pointer_cast | (see dedicated page) |
| cpp/memory/shared_ptr/dsc get_deleter | (see dedicated page) |
| cpp/memory/shared_ptr/dsc operator_cmp | (see dedicated page) |
| cpp/memory/shared_ptr/dsc operator_ltlt | (see dedicated page) |
| cpp/memory/shared_ptr/dsc swap2 | (see dedicated page) |
| cpp/memory/shared_ptr/dsc atomic | (see dedicated page) |

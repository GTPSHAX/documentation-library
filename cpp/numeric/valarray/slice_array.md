...
| cpp/numeric/valarray/array/dsc constructor|slice_array | (see dedicated page) |
| cpp/numeric/valarray/array/dsc destructor|slice_array | (see dedicated page) |
| cpp/numeric/valarray/array/dsc operator{{= | (see dedicated page) |
| cpp/numeric/valarray/array/dsc operator_arith|slice_array | (see dedicated page) |

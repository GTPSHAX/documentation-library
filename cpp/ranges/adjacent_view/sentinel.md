...
| cpp/ranges/adaptor/sentinel/dsc constructor|adjacent_view | (see dedicated page) |
...
| cpp/ranges/adaptor/sentinel/dsc operator-|adjacent_view | (see dedicated page) |
...
| <!-- | |
| cpp/ranges/adjacent_transform_view/dsc sentinel | (see dedicated page) |
| --> | |

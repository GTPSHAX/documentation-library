...
* the number of bytes  of the multibyte character successfully converted from `s`.
...
| cpp/locale/codecvt/dsc do_in|mem=std::codecvt<char16_t, char, std::mbstate_t> | (see dedicated page) |

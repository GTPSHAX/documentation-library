...
[https://www.boost.org/doc/libs/release/doc/html/thread/synchronization.html#thread.synchronization.lock_functions.lock_range Boost provides a version of this function] that takes a sequence of *Lockable* objects defined by a pair of iterators.
`cpp/thread/scoped_lock|std::scoped_lock` offers a RAII wrapper for this function, and is generally preferred to a naked call to `std::lock`.

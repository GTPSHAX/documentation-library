...
| cpp/thread/promise/dsc constructor | (see dedicated page) |
| cpp/thread/promise/dsc destructor | (see dedicated page) |
| cpp/thread/promise/dsc operator{{= | (see dedicated page) |
| cpp/thread/promise/dsc swap | (see dedicated page) |

#### Getting the result

| cpp/thread/promise/dsc get_future | (see dedicated page) |

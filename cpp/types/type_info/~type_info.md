...
type: Utilities
source: https://en.cppreference.com/w/cpp/types/type_info/~type_info
---
...
The dynamic type of a `std::type_info` subobject may be examined by the `cpp/language/typeid` operator.

...
A searcher suitable for use with the *Searcher* overload of `std::search` that implements the [Boyer%E2%80%93Moore%E2%80%93Horspool algorithm|Boyer-Moore-Horspool string searching algorithm](https://en.wikipedia.org/wiki/Boyer%E2%80%93Moore%E2%80%93Horspool algorithm|Boyer-Moore-Horspool string searching algorithm).
...
member|boyer_moore_horspool_searcher|2=

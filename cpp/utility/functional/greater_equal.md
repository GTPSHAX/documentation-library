...
Function object for performing comparisons. The main template invokes `1=operator>=` on type `T`.

## Specializations


| cpp/utility/functional/dsc greater_equal_void | (see dedicated page) |

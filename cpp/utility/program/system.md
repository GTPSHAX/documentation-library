...
On POSIX systems, the return value can be decomposed using [https://pubs.opengroup.org/onlinepubs/9699919799/functions/wait.html `WEXITSTATUS` and `WSTOPSIG`].
The related POSIX function [https://pubs.opengroup.org/onlinepubs/9699919799/functions/popen.html `popen`] makes the output generated by `command` available to the caller.
